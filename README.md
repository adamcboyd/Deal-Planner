...
- `scripts\send-phone-test-samples.ps1` copies the latest generated demo receipt/flyer/pantry TXT, PDF, and PNG files to an authorized Android phone's Downloads folder for deterministic picker checks.
