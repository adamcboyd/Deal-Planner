...
- Latest validated app-code checkpoint: `08bf841 fix: accept object wrapped Gemini pantry fields`
- The branch may include later docs-only recovery commits, but `08bf841` is the latest app-code checkpoint with `testDebugUnitTest assembleDebug lintDebug` passing.
