...
- Latest validated app-code checkpoint: `3b058f9 fix: parse common pantry container units`
- The branch may include later docs-only recovery commits, but `3b058f9` is the latest app-code checkpoint with `testDebugUnitTest assembleDebug lintDebug` passing.
