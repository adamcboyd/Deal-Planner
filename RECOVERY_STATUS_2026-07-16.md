...
- Latest validated app-code checkpoint: `676f9e8 fix: reject weak receipt matches`
- The branch may include later docs-only recovery commits, but `676f9e8` is the latest app-code checkpoint with `testDebugUnitTest assembleDebug lintDebug` passing.
