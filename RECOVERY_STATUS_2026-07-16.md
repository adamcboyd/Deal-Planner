...
- Latest validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after explicit whole-dollar flyer package price parsing work; confirm the exact commit with `git log -1 --oneline`.
