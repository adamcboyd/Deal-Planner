...
- Latest validated app-code checkpoint: `a3ee7ac fix: parse decimal receipt quantities`
- The branch may include later docs-only recovery commits, but `a3ee7ac` is the latest app-code checkpoint with `testDebugUnitTest assembleDebug lintDebug` passing.
