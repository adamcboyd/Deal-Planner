...
- Latest validated app-code checkpoint: `d534c2b fix: parse leading-decimal Gemini pantry values`
- The branch may include later docs-only recovery commits, but `d534c2b` is the latest app-code checkpoint with `testDebugUnitTest assembleDebug lintDebug` passing.
