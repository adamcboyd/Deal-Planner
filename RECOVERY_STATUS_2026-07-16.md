...
- Latest validated app-code checkpoint: `5eeb7a4 fix: parse leading-decimal receipt prices`
- The branch may include later docs-only recovery commits, but `5eeb7a4` is the latest app-code checkpoint with `testDebugUnitTest assembleDebug lintDebug` passing.
