...
$features = @(
    ...
    New-FeatureRow `
        ...
        -Evidence @("app\src\main\java\com\dealplanner\domain\MealPlanningEngine.kt", "app\src\main\java\com\dealplanner\domain\MealPlanRefreshPolicy.kt", "app\src\main\java\com\dealplanner\domain\BudgetEngine.kt", "app\src\main\java\com\dealplanner\domain\ShoppingListExportFormatter.kt", "app\src\main\java\com\dealplanner\ui\export\ShoppingListPdfExporter.kt", "app\src\main\java\com\dealplanner\ui\screens\MenuScreen.kt", "app\src\main\java\com\dealplanner\ui\screens\ShoppingListScreen.kt", "app\src\main\java\com\dealplanner\ui\screens\BudgetScreen.kt", "app\src\main\java\com\dealplanner\util\DietaryRestrictions.kt", "app\src\test\java\com\dealplanner\domain\MealPlanningEngineTest.kt", "app\src\test\java\com\dealplanner\domain\MealPlanRefreshPolicyTest.kt", "app\src\test\java\com\dealplanner\domain\BudgetEngineTest.kt", "app\src\test\java\com\dealplanner\domain\ShoppingListExportFormatterTest.kt", "app\src\test\java\com\dealplanner\util\DietaryRestrictionsTest.kt") `
        -LocalChecks @("Meal planning engine tests", "generated plan refresh policy tests", "custom dietary restriction tests", "budget engine tests", "receipt budget delta tests", "shopping list export formatter tests") `
        -PhoneCheck "Load Demo, generate menu, verify Menu and Shopping refresh after input changes, test custom avoid terms, export PDF/share sheet, edit budget, and relaunch to confirm persistence." `
        -GateGreen $gateGreen
    New-FeatureRow `
        ...
        -LocalChecks @("Gemini missing-key/error summary tests", "settings numeric validation tests", "custom restriction normalization tests", "BuildConfig Gemini snapshot", "optional live Gemini script") `
        -PhoneCheck "Verify no-key fallback and custom avoid-list save, then rebuild with real key and run Test AI Connection plus pantry AI photo. For final AI setup, use -TestGeminiLive." `
        -GateGreen $gateGreen
    New-FeatureRow `
...
- Real Gemini key configured locally, APK rebuilt, `.\scripts\phone-debug-preflight.ps1 -RequireGemini -TestGeminiLive` passed, and Settings -> Test AI Connection succeeded.
