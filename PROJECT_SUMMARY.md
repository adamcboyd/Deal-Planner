...
└── app/
    ...
    └── src/
        ...
        └── test/java/com/dealplanner/
            ├── ai/
            │   └── GeminiPantryVisionClientTest.kt ✅ 11 test cases
            ├── lookup/
...
- ✅ Gemini pantry response parsing for fenced JSON, minor model-output variations, snake_case/name aliases, and malformed string/list fields
...
### 7. Unit Tests (87 Test Cases)
- ✅ GeminiPantryVisionClientTest (11 tests)
...
- ✅ Parses Gemini pantry responses with fenced JSON, scalar warnings/questions, snake_case/name aliases, and clamped confidence
