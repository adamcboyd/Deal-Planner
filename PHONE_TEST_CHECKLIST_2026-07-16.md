...
- Current validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after flyer multibuy hardening; confirm the exact commit with `git log -1 --oneline`.
