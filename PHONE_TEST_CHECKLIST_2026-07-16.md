...
- Current validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after pantry OCR wrapped-date continuation validation; confirm the exact commit with `git log -1 --oneline`.
