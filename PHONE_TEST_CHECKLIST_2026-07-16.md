...
- Current validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after Gemini connection-test seam coverage; confirm the exact commit with `git log -1 --oneline`.
