...
- Current validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after item-first receipt inline-quantity parsing work; confirm the exact commit with `git log -1 --oneline`.
