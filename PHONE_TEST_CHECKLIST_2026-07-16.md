...
- Current validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after savings-only flyer callout filtering work; confirm the exact commit with `git log -1 --oneline`.
