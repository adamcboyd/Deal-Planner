...
- Current validated app-code checkpoint: current `codex/deal-planner-baseline` branch head after receipt edit validation and receipt adjustment calculator extraction; confirm the exact commit with `git log -1 --oneline`.
